...
!function (e, t) {
    ...
    return function (e) {
            ...
            return r(e, [{
                key: "toPersianDigit", value: function (e) {
                    ...
                    return e.toString().replace(/\d+/g, function (e) {
                        ...
                        for (n = 0; n < a.length; n += 1) i.push(String.fromCharCode(a[n] + (t && t === !0 ? 1584 : 1728)));
                        return i.join("")
                    })
                }
            }, {
        ...
        var r = function () {
            ...
            }(), n = a(10), s = a(2), o = a(0), h = a(5), u = (new o).toPersianDigit, d = (new o).leftZeroFill,
            l = (new o).normalizeDuration, c = a(7), y = a(6), f = function () {
                function t(e) {
                ...
                return r(t, [{
                    ...
                    key: "diff", value: function (e, t, a) {
                        var i = this, r = e, n = i.ON.gDate - r.toDate() - 0, s = i.year() - r.year(),
                            o = i.month() - r.month(), h = (i.date() - r.date()) * -1, u = void 0;
                        ...
                        function t(e) {
                            switch (e) {
                                ...
                                case"w":
                                    ...
                                    return s(h);
                                case"ww":
                                    var u = a.startOf("year"), l = d(parseInt(a.diff(u, "days") / 7) + 1, 2);
                                    return s(l);
                                case"M":
                                    return s(r.month);
                                case"MM":
                    ...
                    key: "add", value: function (e, t) {
                        var a = new h(e, t)._data, i = l(e, t).unit;
                        if (t = l(e, t).value, "year" === i || "month" === i) {
                            ...
                            if (a.months > 0) {
                                var n = this.date(), s = this.month() + a.months, o = this.daysInMonth(this.year(), s);
                                n >= o && (n = o), this.date(n), this.month(s)
                            }
                        }
                        if ("day" === i) {
                            var u = this.hour(), d = this.valueOf() + 24 * t * 60 * 60 * 1e3;
                    ...
                    key: "subtract", value: function (e, t) {
                        ...
                        if (t = l(e, t).value, "year" === i || "month" === i) {
                            ...
                            if (a.months > 0) {
                                var n = this.date(), s = this.month() - a.months;
                                this.month(s);
        ...
        var r = function e() {
            i(this, e), this.gDate = null, this.modifiedjulianday = 0, this.julianday = 0, this.gregserial = {day: 0}, this.zone = 0, this.gregorian = {
                year: 0,
                month: 0,
                day: 0,
                hour: 0,
